# Contribuir a Awesome Extremadura
...
- El proyecto debe **dar soporte específico a Extremadura** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución extremeña** a la que el software da soporte (p.ej. juntaex.es, unex.es). Esto ayuda a verificar que el proyecto es relevante para Extremadura.
