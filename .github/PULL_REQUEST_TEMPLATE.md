...
- URL del repositorio
- URL del servicio/API/institución extremeña a la que da soporte (p.ej. juntaex.es, unex.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución extremeña |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Extremadura, etc.)
Elimina esta sección si no aplica.
-->
