...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Extremadura. No basta con que el autor sea de Extremadura o resida aquí. Un framework genérico creado por un developer de Extremadura no pertenece a esta lista. Un cliente para una API de servicios de Extremadura sí.
